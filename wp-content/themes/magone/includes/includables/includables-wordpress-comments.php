...
function magone_show_comment_items($comment, $args, $depth) {
	...
	if (!$default_avatar) {
		$default_avatar = 'http://assets.tumblr.com/images/default_avatar_64.png';
	}
	...
	<?php if ($author_url): ?>
		<a class="comment-avatar" href="<?php echo esc_url($author_url); ?>" target="_blank"><?php echo $author_avatar; ?></a>
	<?php else: ?>
    ...
    <div class="comment-content">
        <div class="comment-header">
			<?php if ($author_url): ?>
				<a class="comment-name" href="<?php echo esc_url($author_url); ?>" target="_blank"><?php echo $comment->comment_author; ?></a>
			<?php else: ?>
