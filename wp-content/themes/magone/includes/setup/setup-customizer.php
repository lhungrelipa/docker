	...
	'general' => array(
		...
		'settings' => array(			
			...
			'default_post_thumbnail' => array(
				...
				'type' => 'image', 
				'default' => 'http://lorempixel.com/640/300/'
			),
	...
	'styles' => array(
		...
		'settings' => array(
			'main_color' => array(
				...
				'type' => 'color', 
				'default' => '#FF3D00',
				'cssout' => 'a,a:hover,.color {color: %s;}.border {border-color: %s;}.bg {background-color: %s;}.main-menu {border-top: 1px solid %s;}.main-menu ul.sub-menu li:hover > a {border-left: 2px solid %s;}.main-menu .menu-item-mega > .menu-item-inner > .sub-menu {border-top: 2px solid %s;}.main-menu .menu-item-mega > .menu-item-inner > .sub-menu > li li:hover a {border-left: 1px solid %s;}.main-menu ul.sub-menu li:hover > a, .main-menu .menu-item-mega > .menu-item-inner > .sub-menu, .main-menu .menu-item-mega > .menu-item-inner > .sub-menu > li li:hover a {border-color: %s!important;}.header-social-icons ul li a:hover {color: %s;}.owl-dot.active,.main-sidebar .widget.follow-by-email .follow-by-email-submit {background: %s;}#footer .widget.social_icons li a:hover {color: %s;}#footer .follow-by-email .follow-by-email-submit, #mc_embed_signup .button, .wpcf7-form-control[type="submit"] {background: %s!important;}.feed.widget .feed-widget-header {border-color: %s;}.feed.widget.box-title h2.widget-title {background: %s;}.social_counter {color: %s}.social_counter .button {background: %s}'
			),
	...
	'footer' => array(
		...
		'settings' => array(
			...
			'copyright_2' => array(
				...
				'default' => 'Designed by <a href="http://themeforest.net/item/magone-responsive-magazine-news-wordpress-theme/14342350?ref=tiennguyenvan">MagOne</a>'
			)
		)
	),
	'custom_code' => array(
